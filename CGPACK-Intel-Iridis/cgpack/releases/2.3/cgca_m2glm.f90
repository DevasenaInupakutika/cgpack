!$Id: cgca_m2glm.f90 82 2015-03-30 09:09:37Z mexas $
...
if (.not. allocated(coarray)) then
 write (*,'(a,i0)') "ERROR in cgca_gl: image", thisimage
 write (*,'(a)') "ERROR in cgca_gl: coarray is not allocated"
 error stop
end if
...
if (any(super .gt. usup) .or. any(super .lt. 1)) then
 write (*,'(a,i0)') "ERROR in cgca_gl: image", thisimage
 write (*,'(a)') "ERROR in cgca_gl: one or more super array&
                  & coordinate(s) are ouside the bounds"
 write (*,'(a,3(i0,tr1))') "ERROR in cgca_gl: super array coord: ",super
 write (*,'(a)') "ERROR in cgca_gl: lower bound must be 1"
 write (*,'(a,3(i0,tr1))') "ERROR in cgca_gl: upper bounds: ", usup
 error stop
end if
...
if (any(imgpos .gt. ucob) .or. any(imgpos .lt. lcob)) then
 write (*,'(a,i0)') "ERROR in cgca_gl: image", thisimage
 write (*,'(a)') "ERROR in cgca_lg: one or more image positions&
                  & are ouside the bounds"
 write (*,'(a,3(i0,tr1))') &
  "ERROR in cgca_gl: image positions: ",imgpos
 write (*,'(a,3(i0,tr1))') &
  "ERROR in cgca_gl: lower image grid bounds: ", lcob
 write (*,'(a,3(i0,tr1))') &
  "ERROR in cgca_gl: upper image grid bounds: ", ucob
 error stop
end if

if (any(local .gt. ubr(1:3)) .or. any(local .lt. lbr(1:3))) then
 write (*,'(a,i0)') "ERROR in cgca_gl: image", thisimage
 write (*,'(a)') "ERROR in cgca_lg: one or more local coordinates &
                  & are ouside the bounds"
 write (*,'(a,3(i0,tr1))') "ERROR in cgca_gl: local coordinates: ",local
 write (*,'(a,3(i0,tr1))') "ERROR in cgca_gl: lower bounds: ", lbr
 write (*,'(a,3(i0,tr1))') "ERROR in cgca_gl: upper bounds: ", ubr
 error stop
end if
...
if (.not. allocated(coarray)) then
 write (*,'(a,i0)') "ERROR in cgca_lg: image", thisimage
 write (*,'(a)') "ERROR in cgca_lg: coarray is not allocated"
 error stop
end if
...
if (any(imgpos .gt. ucob) .or. any(imgpos .lt. lcob)) then
 ...
 write (*,'(a)') "ERROR in cgca_lg: one or more image positions&
                  & are ouside the bounds"
 write (*,'(a,3(i0,tr1))') "ERROR in cgca_lg: image positions: ",imgpos
 write (*,'(a,3(i0,tr1))') &
  "ERROR in cgca_lg: lower image grid bounds: ", lcob
 write (*,'(a,3(i0,tr1))') &
  "ERROR in cgca_lg: upper image grid bounds: ", ucob
 error stop
end if
...
if (any(local .gt. ubr(1:3)) .or. any(local .lt. lbr(1:3))) then
 ...
 write (*,'(a)') "ERROR in cgca_lg: one or more local coordinates&
                  & are ouside the bounds"
 write (*,'(a,3(i0,tr1))') &
  "ERROR in cgca_lg: local coordinates: ", local
 write (*,'(a,3(i0,tr1))') &
  "ERROR in cgca_lg: lower bounds: ", lbr
 write (*,'(a,3(i0,tr1))') &
  "ERROR in cgca_lg: upper bounds: ", ubr
 error stop
end if
...
if (any(super .gt. usup) .or. any(super .lt. 1)) then
 write (*,'(a,i0)') "ERROR in cgca_lg: image", thisimage
 write (*,'(a)') "ERROR in cgca_lg: one or more super array &
                  & coordinates are ouside the bounds"
 write (*,'(a,3(i0,tr1))') &
  "ERROR in cgca_lg: super array coord: ",super
 write (*,'(a)') "ERROR in cgca_lg: lower bound must be 1"
 write (*,'(a,3(i0,tr1))') "ERROR in cgca_lg: upper bounds: ", usup
 error stop
end if
