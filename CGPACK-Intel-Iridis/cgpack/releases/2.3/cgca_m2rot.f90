!$Id: cgca_m2rot.f90 82 2015-03-30 09:09:37Z mexas $
...
if (isnan(angle)) then
  write (*,'(a,i0)') "ERROR in cgca_mis: image: ", this_image()
  write (*,'(a,i0)') "ERROR in cgca_mis: arg: ", arg
  write (*,'(a,i0)') "ERROR in cgca_mis: angle=acos(arg) is NAN"
  error stop
end if
