!$Id: cgca_m3sld.F90 95 2015-06-09 11:15:58Z mexas $
...
!  CONTAINS
!    cgca_sld, cgca_sld1, cgca_sld2, and on Cray, cgca_sld3
!  USES
...
if ( errstat .ne. 0 ) then
  write (*,'(a,i0)')                                                   &
    "ERROR: cgca_sld: allocate( yesnuclei[*] ), img: ", thisimage
  error stop
end if
...
if ( errstat .ne. 0 ) then
  write (*,'(a,i0)')                                                   &
    "ERROR: cgca_sld: allocate( finished[*] ), img: ", thisimage
  error stop
end if
...
if ( errstat .ne. 0 ) then
  write (*,'(a,i0)')                                                   &
    "ERROR: cgca_sld: allocate( allfinished[*] ), img: ", thisimage
  error stop
end if
...
if ( errstat .ne. 0 ) then
  write (*,'(a,i0)')                                                   &
    "ERROR: cgca_sld: deallocate( yesnuclei[*] ), img: ", thisimage
  error stop
end if
...
if ( errstat .ne. 0 ) then
  write (*,'(a,i0)')                                                   &
    "ERROR: cgca_sld: deallocate( finished[*] ), img: ", thisimage
  error stop
end if
...
allocate( array( lbv(1):ubv(1) , lbv(2):ubv(2) , lbv(3):ubv(3) ),      &
          ...
          stat=errstat )
if ( errstat .ne. 0 ) then
  write (*,'(a,i0,a)') "ERROR: cgca_sld2: img: ", img,                 &
