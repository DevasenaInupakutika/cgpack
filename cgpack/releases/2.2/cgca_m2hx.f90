!$Id: cgca_m2hx.f90 14 2014-12-01 10:14:16Z mexas $
...
! into halos. There must not ever be copying real values
...
! check for allocated 
if (.not. allocated(coarray)) &
  error stop "****** ERROR in cgca_hlg: coarray is not allocated"
