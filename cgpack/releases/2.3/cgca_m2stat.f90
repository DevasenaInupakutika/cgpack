!$Id: cgca_m2stat.f90 82 2015-03-30 09:09:37Z mexas $
...
do i = 1 , frsize
 counter( i ) = counter( i ) + count( coarray( lb(1):ub(1) ,           &
                lb(2):ub(2) , lb(3):ub(3) , cgca_state_type_frac )     &
                .eq. cgca_frac_states(i), kind=ilrg )
end do
