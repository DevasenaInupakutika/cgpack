!$Id: cgca_m2alloc.f90 99 2015-06-10 13:47:07Z mexas $
...
if (errstat .ne. 0) then
 write (*,'(a,i0)') "ERROR: cgca_as: image: ", this_image()
 write (*,'(a)')    "ERROR: cgca_as: cannot allocate coarray"
 write (*,'(a,i0)') "ERROR: cgca_as: error code: ", errstat
 error stop
end if
